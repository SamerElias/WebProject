...
public class PurchaseBook extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			stmt.setString(1, recevied.bookname);
			rs = stmt.executeQuery();
			double price = 0;
			if(rs.next()) {
			price = rs.getDouble("Price");
			}
			stmt = conn.prepareStatement(AppConstants.INSERT_OWNED_STMT);
	...
	class JsonPostRequest{
		...
		public JsonPostRequest(String username, String password, String bookname) {
			super();
