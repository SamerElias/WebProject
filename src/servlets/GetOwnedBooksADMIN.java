...
/**
 * Servlet for getting purchased books for choosen customer.
 */
@WebServlet(
		urlPatterns = { "/GetOwnedBooksADMIN" }, 
		initParams = { 
				@WebInitParam(name = "Username", value = "")
		})
public class GetOwnedBooksADMIN extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetOwnedBooksADMIN() {
        super();
