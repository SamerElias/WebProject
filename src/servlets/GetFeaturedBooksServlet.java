...
/**
 * Servlet implementation class GetFeaturedBooksServlet
 */
@WebServlet("/GetFeaturedBooksServlet")
public class GetFeaturedBooksServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetFeaturedBooksServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			stmt = conn.prepareStatement(AppConstants.SELECT_BOOKS_BY_FEATURED);
			stmt.setInt(1, 1);
