...
/**
 * Application Lifecycle Listener implementation class zManageReviewsDBFromJson
 *
 */
@WebListener
public class zManageReviewsDBFromJson implements ServletContextListener {

    /**
     * Default constructor. 
     */
    public zManageReviewsDBFromJson() {
    ...
    public void contextInitialized(ServletContextEvent event)  { 
    	...
    	try{
    		...
    		if (!created){
    			...
    			Collection<Review> reviews = loadBooksLikes(cntx.getResourceAsStream(File.separator +
    			...
    			for (Review review : reviews){
    				...
    				pstmt.setInt(4, review.getAccepted());
...
private Collection<Review> loadBooksLikes(InputStream is) throws IOException{
